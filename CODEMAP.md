...
| Файлів CSS | 32 |
| Рядків CSS | 8637 |
| Сутностей верхнього рівня | 1567 |
...
| `src/scripts/core/01-base.js` | 326 | 39 |
...
| `src/scripts/core/12-ai-agent.js` | 1527 | 69 |
...
| `wordLevelTranslate` | функція | `src/scripts/core/01-base.js:179` |
| `UI_CACHE_KEY` | значення | `src/scripts/core/01-base.js:196` |
| `uiHash` | функція | `src/scripts/core/01-base.js:197` |
| `uiCacheGet` | функція | `src/scripts/core/01-base.js:198` |
| `uiCacheSet` | функція | `src/scripts/core/01-base.js:199` |
| `uiInFlight` | обʼєкт | `src/scripts/core/01-base.js:200` |
| `uiQueue` | масив | `src/scripts/core/01-base.js:201` |
| `uiPump` | функція | `src/scripts/core/01-base.js:202` |
| `HAS_CYR` | значення | `src/scripts/core/01-base.js:208` |
| `autoTranslateNode` | функція | `src/scripts/core/01-base.js:209` |
| `translateNode` | функція | `src/scripts/core/01-base.js:233` |
| `i18nApply` | функція | `src/scripts/core/01-base.js:251` |
| `window.i18nApply` | значення | `src/scripts/core/01-base.js:255` |
| `raf` | значення | `src/scripts/core/01-base.js:258` |
| `mo` | функція | `src/scripts/core/01-base.js:259` |
| `contentTranslateOn` | функція | `src/scripts/core/01-base.js:276` |
| `window.flowContentTranslateOn` | значення | `src/scripts/core/01-base.js:279` |
| `hash` | функція | `src/scripts/core/01-base.js:280` |
| `cacheGet` | функція | `src/scripts/core/01-base.js:281` |
| `cacheSet` | функція | `src/scripts/core/01-base.js:282` |
| `window.flowTranslateContent` | функція | `src/scripts/core/01-base.js:287` |
| `window.__flowErrors` | масив | `src/scripts/core/01-base.js:314` |
| `push` | функція | `src/scripts/core/01-base.js:315` |
| `window.flowErrors` | функція | `src/scripts/core/01-base.js:324` |
...
| `AI_AGENT_ADDON` | значення | `src/scripts/core/12-ai-agent.js:513` |
| `flowToolExec` | функція | `src/scripts/core/12-ai-agent.js:529` |
| `flowToolRead` | функція | `src/scripts/core/12-ai-agent.js:556` |
| `aiRemindWhen` | функція | `src/scripts/core/12-ai-agent.js:646` |
| `flowToolPlanner` | функція | `src/scripts/core/12-ai-agent.js:653` |
| `flowToolGoals` | функція | `src/scripts/core/12-ai-agent.js:719` |
| `aiToolConfirm` | функція | `src/scripts/core/12-ai-agent.js:754` |
| `aiFinConfirm` | функція | `src/scripts/core/12-ai-agent.js:773` |
| `flowToolFinance` | функція | `src/scripts/core/12-ai-agent.js:776` |
| `flowToolDiary` | функція | `src/scripts/core/12-ai-agent.js:924` |
| `flowToolPatterns` | функція | `src/scripts/core/12-ai-agent.js:974` |
| `flowToolMemory` | функція | `src/scripts/core/12-ai-agent.js:995` |
| `flowToolFolders` | функція | `src/scripts/core/12-ai-agent.js:1012` |
| `aiPickModel` | функція | `src/scripts/core/12-ai-agent.js:1065` |
| `aiUsageAdd` | функція | `src/scripts/core/12-ai-agent.js:1073` |
| `aiCallRaw` | функція | `src/scripts/core/12-ai-agent.js:1085` |
| `aiToolIsWrite` | функція | `src/scripts/core/12-ai-agent.js:1146` |
| `AI_WRITE_LIMIT` | значення | `src/scripts/core/12-ai-agent.js:1155` |
| `aiAgentTurn` | функція | `src/scripts/core/12-ai-agent.js:1156` |
| `aiFinMonthNet` | функція | `src/scripts/core/12-ai-agent.js:1202` |
| `aiFinCtx` | функція | `src/scripts/core/12-ai-agent.js:1210` |
| `aiCtx` | функція | `src/scripts/core/12-ai-agent.js:1230` |
| `aiFindGoal` | функція | `src/scripts/core/12-ai-agent.js:1269` |
| `aiParseBlocks` | функція | `src/scripts/core/12-ai-agent.js:1273` |
| `aiOpsCount` | функція | `src/scripts/core/12-ai-agent.js:1304` |
| `aiStreamText` | функція | `src/scripts/core/12-ai-agent.js:1309` |
| `aiFindBlockByT` | функція | `src/scripts/core/12-ai-agent.js:1314` |
| `aiFindFolderKey` | функція | `src/scripts/core/12-ai-agent.js:1320` |
| `aiBuildPageBlock` | функція | `src/scripts/core/12-ai-agent.js:1328` |
| `aiApplyPages` | функція | `src/scripts/core/12-ai-agent.js:1347` |
| `aiApplyActions` | функція | `src/scripts/core/12-ai-agent.js:1370` |
| `aiCommit` | функція | `src/scripts/core/12-ai-agent.js:1461` |
| `aiUndo` | функція | `src/scripts/core/12-ai-agent.js:1477` |
...
| `spotMicToggle` | функція | `src/scripts/core/15-flow-spot.js:142` |
| `window.flowCapRender` | значення | `src/scripts/core/15-flow-spot.js:171` |
| `window.flowSpotOpen` | значення | `src/scripts/core/15-flow-spot.js:172` |
| `aiChatSheet` | функція | `src/scripts/core/15-flow-spot.js:175` |
| `aiClose` | функція | `src/scripts/core/15-flow-spot.js:208` |
| `aiDayPct` | функція | `src/scripts/core/15-flow-spot.js:215` |
| `aiVoiceOn` | значення | `src/scripts/core/15-flow-spot.js:222` |
| `aiSpeakStop` | функція | `src/scripts/core/15-flow-spot.js:224` |
| `aiSpeak` | функція | `src/scripts/core/15-flow-spot.js:225` |
| `aiVoiceToggle` | функція | `src/scripts/core/15-flow-spot.js:265` |
| `aiRenderHead` | функція | `src/scripts/core/15-flow-spot.js:272` |
| `aiMemSheet` | функція | `src/scripts/core/15-flow-spot.js:316` |
| `aiRenderViews` | функція | `src/scripts/core/15-flow-spot.js:338` |
| `aiPendingMsg` | функція | `src/scripts/core/15-flow-spot.js:343` |
| `aiLogHTML` | функція | `src/scripts/core/15-flow-spot.js:354` |
| `aiTlHTML` | функція | `src/scripts/core/15-flow-spot.js:361` |
| `aiActsHTML` | функція | `src/scripts/core/15-flow-spot.js:384` |
| `aiTraceLiveHTML` | функція | `src/scripts/core/15-flow-spot.js:424` |
| `aiTraceRowHTML` | функція | `src/scripts/core/15-flow-spot.js:430` |
| `AI_SHELF_GO` | обʼєкт | `src/scripts/core/15-flow-spot.js:435` |
| `aiShelfHTML` | функція | `src/scripts/core/15-flow-spot.js:436` |
| `aiTraceKpisHTML` | функція | `src/scripts/core/15-flow-spot.js:446` |
| `aiWireBody` | функція | `src/scripts/core/15-flow-spot.js:461` |
| `aiChipsHTML` | функція | `src/scripts/core/15-flow-spot.js:480` |
| `AI_SVG` | обʼєкт | `src/scripts/core/15-flow-spot.js:486` |
| `AI_ICO` | обʼєкт | `src/scripts/core/15-flow-spot.js:494` |
| `aiIco` | функція | `src/scripts/core/15-flow-spot.js:517` |
| `aiMD` | функція | `src/scripts/core/15-flow-spot.js:522` |
| `aiBusyHTML` | функція | `src/scripts/core/15-flow-spot.js:528` |
| `aiSlashHide` | функція | `src/scripts/core/15-flow-spot.js:536` |
| `aiSlashShow` | функція | `src/scripts/core/15-flow-spot.js:537` |
| `aiAttachRender` | функція | `src/scripts/core/15-flow-spot.js:552` |
| `aiImgShrink` | функція | `src/scripts/core/15-flow-spot.js:564` |
| `aiFileB64` | функція | `src/scripts/core/15-flow-spot.js:581` |
| `aiPickFile` | функція | `src/scripts/core/15-flow-spot.js:589` |
| `aiPlusSheet` | функція | `src/scripts/core/15-flow-spot.js:614` |
| `aiPromptsSheet` | функція | `src/scripts/core/15-flow-spot.js:634` |
| `aiPromptEdit` | функція | `src/scripts/core/15-flow-spot.js:653` |
| `aiEnvKpi` | функція | `src/scripts/core/15-flow-spot.js:670` |
| `aiPlanCardHTML` | функція | `src/scripts/core/15-flow-spot.js:678` |
| `aiRenderBody` | функція | `src/scripts/core/15-flow-spot.js:704` |
| `AI_SKILLS` | обʼєкт | `src/scripts/core/15-flow-spot.js:754` |
| `aiSkillFor` | функція | `src/scripts/core/15-flow-spot.js:766` |
| `aiSumBusy` | значення | `src/scripts/core/15-flow-spot.js:773` |
| `aiMaybeSummarize` | функція | `src/scripts/core/15-flow-spot.js:774` |
| `aiChatSend` | функція | `src/scripts/core/15-flow-spot.js:786` |
