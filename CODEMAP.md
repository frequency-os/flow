...
| Файлів CSS | 32 |
| Рядків CSS | 8637 |
| Сутностей верхнього рівня | 1570 |
...
| `src/scripts/core/12-ai-agent.js` | 1602 | 78 |
| `src/scripts/core/13-pets.js` | 216 | 13 |
| `src/scripts/core/14-react.js` | 335 | 43 |
| `src/scripts/core/15-flow-spot.js` | 2112 | 104 |
...
### `src/scripts/core/12-ai-agent.js` — 78 сутностей
...
| `AI_AGENT_ADDON` | значення | `src/scripts/core/12-ai-agent.js:496` |
| `flowToolExec` | функція | `src/scripts/core/12-ai-agent.js:512` |
| `flowToolRead` | функція | `src/scripts/core/12-ai-agent.js:539` |
| `aiRemindWhen` | функція | `src/scripts/core/12-ai-agent.js:629` |
| `flowToolPlanner` | функція | `src/scripts/core/12-ai-agent.js:636` |
| `flowToolGoals` | функція | `src/scripts/core/12-ai-agent.js:707` |
| `aiToolConfirm` | функція | `src/scripts/core/12-ai-agent.js:745` |
| `aiFinConfirm` | функція | `src/scripts/core/12-ai-agent.js:764` |
| `flowToolFinance` | функція | `src/scripts/core/12-ai-agent.js:767` |
| `flowToolDiary` | функція | `src/scripts/core/12-ai-agent.js:915` |
| `flowToolPatterns` | функція | `src/scripts/core/12-ai-agent.js:965` |
| `flowToolMemory` | функція | `src/scripts/core/12-ai-agent.js:986` |
| `flowToolFolders` | функція | `src/scripts/core/12-ai-agent.js:1003` |
| `aiPickModel` | функція | `src/scripts/core/12-ai-agent.js:1056` |
| `aiUsageAdd` | функція | `src/scripts/core/12-ai-agent.js:1064` |
| `aiCallRaw` | функція | `src/scripts/core/12-ai-agent.js:1076` |
| `aiToolIsWrite` | функція | `src/scripts/core/12-ai-agent.js:1137` |
| `AI_WRITE_LIMIT` | значення | `src/scripts/core/12-ai-agent.js:1146` |
| `aiTurnWrites` | значення | `src/scripts/core/12-ai-agent.js:1147` |
| `aiToolWriteCost` | функція | `src/scripts/core/12-ai-agent.js:1152` |
| `aiAgentTurn` | функція | `src/scripts/core/12-ai-agent.js:1157` |
| `aiFinMonthNet` | функція | `src/scripts/core/12-ai-agent.js:1205` |
| `aiFinCtx` | функція | `src/scripts/core/12-ai-agent.js:1213` |
| `aiCtx` | функція | `src/scripts/core/12-ai-agent.js:1233` |
| `aiFindGoal` | функція | `src/scripts/core/12-ai-agent.js:1272` |
| `aiParseBlocks` | функція | `src/scripts/core/12-ai-agent.js:1276` |
| `aiOpsCount` | функція | `src/scripts/core/12-ai-agent.js:1307` |
| `aiStreamText` | функція | `src/scripts/core/12-ai-agent.js:1312` |
| `aiOpDs` | функція | `src/scripts/core/12-ai-agent.js:1322` |
| `aiOpMatches` | функція | `src/scripts/core/12-ai-agent.js:1323` |
| `aiOpBlock` | функція | `src/scripts/core/12-ai-agent.js:1333` |
| `aiFindBlockByT` | функція | `src/scripts/core/12-ai-agent.js:1334` |
| `aiOpWarn` | функція | `src/scripts/core/12-ai-agent.js:1336` |
| `aiResolveOps` | функція | `src/scripts/core/12-ai-agent.js:1348` |
| `aiMissText` | функція | `src/scripts/core/12-ai-agent.js:1362` |
| `aiOpRow` | функція | `src/scripts/core/12-ai-agent.js:1369` |
| `aiGateOps` | функція | `src/scripts/core/12-ai-agent.js:1376` |
| `aiFindFolderKey` | функція | `src/scripts/core/12-ai-agent.js:1396` |
| `aiBuildPageBlock` | функція | `src/scripts/core/12-ai-agent.js:1404` |
| `aiApplyPages` | функція | `src/scripts/core/12-ai-agent.js:1423` |
| `aiApplyActions` | функція | `src/scripts/core/12-ai-agent.js:1446` |
| `aiCommit` | функція | `src/scripts/core/12-ai-agent.js:1536` |
| `aiUndo` | функція | `src/scripts/core/12-ai-agent.js:1552` |
...
| `spotMicToggle` | функція | `src/scripts/core/15-flow-spot.js:147` |
| `window.flowCapRender` | значення | `src/scripts/core/15-flow-spot.js:176` |
| `window.flowSpotOpen` | значення | `src/scripts/core/15-flow-spot.js:177` |
| `aiChatSheet` | функція | `src/scripts/core/15-flow-spot.js:180` |
| `aiClose` | функція | `src/scripts/core/15-flow-spot.js:213` |
| `aiDayPct` | функція | `src/scripts/core/15-flow-spot.js:220` |
| `aiVoiceOn` | значення | `src/scripts/core/15-flow-spot.js:227` |
| `aiSpeakStop` | функція | `src/scripts/core/15-flow-spot.js:229` |
| `aiSpeak` | функція | `src/scripts/core/15-flow-spot.js:230` |
| `aiVoiceToggle` | функція | `src/scripts/core/15-flow-spot.js:270` |
| `aiRenderHead` | функція | `src/scripts/core/15-flow-spot.js:277` |
| `aiMemSheet` | функція | `src/scripts/core/15-flow-spot.js:321` |
| `aiRenderViews` | функція | `src/scripts/core/15-flow-spot.js:343` |
| `aiPendingMsg` | функція | `src/scripts/core/15-flow-spot.js:348` |
| `aiLogHTML` | функція | `src/scripts/core/15-flow-spot.js:359` |
| `aiTlHTML` | функція | `src/scripts/core/15-flow-spot.js:366` |
| `aiActsHTML` | функція | `src/scripts/core/15-flow-spot.js:389` |
| `aiTraceLiveHTML` | функція | `src/scripts/core/15-flow-spot.js:429` |
| `aiTraceRowHTML` | функція | `src/scripts/core/15-flow-spot.js:435` |
| `AI_SHELF_GO` | обʼєкт | `src/scripts/core/15-flow-spot.js:440` |
| `aiShelfHTML` | функція | `src/scripts/core/15-flow-spot.js:441` |
| `aiTraceKpisHTML` | функція | `src/scripts/core/15-flow-spot.js:451` |
| `aiWireBody` | функція | `src/scripts/core/15-flow-spot.js:466` |
...
| `aiPlusSheet` | функція | `src/scripts/core/15-flow-spot.js:621` |
| `aiPromptsSheet` | функція | `src/scripts/core/15-flow-spot.js:641` |
| `aiPromptEdit` | функція | `src/scripts/core/15-flow-spot.js:660` |
| `aiEnvKpi` | функція | `src/scripts/core/15-flow-spot.js:677` |
| `aiPlanCardHTML` | функція | `src/scripts/core/15-flow-spot.js:685` |
| `aiRenderBody` | функція | `src/scripts/core/15-flow-spot.js:711` |
| `AI_SKILLS` | обʼєкт | `src/scripts/core/15-flow-spot.js:761` |
| `aiSkillFor` | функція | `src/scripts/core/15-flow-spot.js:773` |
| `aiSumBusy` | значення | `src/scripts/core/15-flow-spot.js:780` |
| `aiMaybeSummarize` | функція | `src/scripts/core/15-flow-spot.js:781` |
| `aiChatSend` | функція | `src/scripts/core/15-flow-spot.js:793` |
| `aiRec` | значення | `src/scripts/core/15-flow-spot.js:888` |
| `aiMicUI` | функція | `src/scripts/core/15-flow-spot.js:889` |
| `aiMicToggle` | функція | `src/scripts/core/15-flow-spot.js:890` |
| `aiTranscribeBlob` | функція | `src/scripts/core/15-flow-spot.js:928` |
| `aiTranscribe` | функція | `src/scripts/core/15-flow-spot.js:951` |
| `window.aiChatSheet` | значення | `src/scripts/core/15-flow-spot.js:955` |
| `plStreak` | функція | `src/scripts/core/15-flow-spot.js:957` |
| `plBestStreak` | функція | `src/scripts/core/15-flow-spot.js:966` |
| `plWeekDots` | функція | `src/scripts/core/15-flow-spot.js:980` |
| `heroWeekDays` | функція | `src/scripts/core/15-flow-spot.js:1005` |
| `heroMonthDays` | функція | `src/scripts/core/15-flow-spot.js:1023` |
| `heroDayWord` | функція | `src/scripts/core/15-flow-spot.js:1034` |
| `renderHeroStreak` | функція | `src/scripts/core/15-flow-spot.js:1040` |
| `plRolloverHTML` | функція | `src/scripts/core/15-flow-spot.js:1063` |
| `plDaySummaryHTML` | функція | `src/scripts/core/15-flow-spot.js:1075` |
| `plAutoSuggestHTML` | функція | `src/scripts/core/15-flow-spot.js:1109` |
| `plQAnchorsHTML` | функція | `src/scripts/core/15-flow-spot.js:1151` |
| `plWeekCalHTML` | функція | `src/scripts/core/15-flow-spot.js:1176` |
| `plDayTitle` | функція | `src/scripts/core/15-flow-spot.js:1199` |
| `plBlocksDisplay` | функція | `src/scripts/core/15-flow-spot.js:1212` |
| `plFolderDayVal` | функція | `src/scripts/core/15-flow-spot.js:1225` |
| `plFolderMonthVal` | функція | `src/scripts/core/15-flow-spot.js:1230` |
| `plFolderComplete` | функція | `src/scripts/core/15-flow-spot.js:1239` |
| `DOW_UA` | масив | `src/scripts/core/15-flow-spot.js:1244` |
| `plRuleDowsLabel` | функція | `src/scripts/core/15-flow-spot.js:1245` |
| `plFolderDaySheet` | функція | `src/scripts/core/15-flow-spot.js:1254` |
| `plFolderMonthSheet` | функція | `src/scripts/core/15-flow-spot.js:1311` |
| `PL_MXQ` | масив | `src/scripts/core/15-flow-spot.js:1376` |
| `plMatrixHTML` | функція | `src/scripts/core/15-flow-spot.js:1377` |
| `plMxSchedule` | функція | `src/scripts/core/15-flow-spot.js:1396` |
| `plSlotTask` | функція | `src/scripts/core/15-flow-spot.js:1410` |
| `plBacklogHTML` | функція | `src/scripts/core/15-flow-spot.js:1424` |
| `plInboxHTML` | функція | `src/scripts/core/15-flow-spot.js:1439` |
| `plBlockEnd` | функція | `src/scripts/core/15-flow-spot.js:1454` |
| `plDayHTML` | функція | `src/scripts/core/15-flow-spot.js:1455` |
| `plTaskCard` | функція | `src/scripts/core/15-flow-spot.js:1664` |
| `plAdd` | функція | `src/scripts/core/15-flow-spot.js:1687` |
| `plAddBlockAt` | функція | `src/scripts/core/15-flow-spot.js:1714` |
| `plLinkTag` | функція | `src/scripts/core/15-flow-spot.js:1719` |
| `plScheduleStep` | функція | `src/scripts/core/15-flow-spot.js:1727` |
| `plMicroBlock` | функція | `src/scripts/core/15-flow-spot.js:1744` |
| `plCompleteBlock` | функція | `src/scripts/core/15-flow-spot.js:1757` |
| `plUncompleteEffects` | функція | `src/scripts/core/15-flow-spot.js:1812` |
| `plToast` | функція | `src/scripts/core/15-flow-spot.js:1828` |
| `plBlockSheet` | функція | `src/scripts/core/15-flow-spot.js:1836` |
| `plEditBlock` | функція | `src/scripts/core/15-flow-spot.js:2058` |
| `plRangeSheet` | функція | `src/scripts/core/15-flow-spot.js:2061` |
